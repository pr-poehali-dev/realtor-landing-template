"""Управление объявлениями коммерческой недвижимости: получение и создание."""
import json
import os
import psycopg2
...
def handler(event: dict, context) -> dict:
    ...
    if method == "GET":
        ...
        cur = conn.cursor()
        cur.execute(
            "SELECT id, title, category, area, price, price_type, address, description, photos, floor, features, created_at "
